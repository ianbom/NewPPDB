        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              ...
              <h4 class="text-info fw-bold">{{ $totalUser }}</h4>
            </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              ...
              <h4 class="text-success fw-bold">{{ $userDiterima }}</h4>
            </div>
            <div class="progress progress-sm">
              <div
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              ...
              <h4 class="text-danger fw-bold">{{ $userDitolak }}</h4>
            </div>
            <div class="progress progress-sm">
              <div
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              ...
              <h4 class="text-secondary fw-bold">{{ $userProses }}</h4>
            </div>
            <div class="progress progress-sm">
              <div
